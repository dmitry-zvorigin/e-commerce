        ...
        <div class="col-md-11 mt-4 mx-auto">
            <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 me-4">
                    <div class="ms-4">
                        <button type="button" class="load-comments-child-btn btn btn-outline-secondary" data-comment-append-id="{{ $comment->id }}">Ответы (10)</button>
                    </div>
            ...
            <div id="comments-block-child{{ $comment->id }}" class="comments-block"></div>    
        </div>
    @endforeach
</div>
